...
// Rows fold in three places, and they share one chevron class: .party-row in all three party
// groupings, .droplog-row on a stacking drop in the Drop Log, a table row in Run Order. The open
