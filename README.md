...
**Refuse a screenshot it can actually read.** A rescaled capture — remote play, display scaling —
is read at its own scale rather than rejected. Only a *downscaled* one is refused, because that
