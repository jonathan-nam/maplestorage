...
FROM (VALUES
    ('oath-of-death', 'Oath of Death', 'oath-of-death.png', NULL, NULL, 1, 0),
    ('immortal-legacy', 'Immortal Legacy', 'immortal-legacy.png', NULL, NULL, 1, 1),
    ('exceptional-hammer-face', 'Exceptional Hammer (Face Acc)', 'exceptional-hammer-face.png', NULL, NULL, 1, 2),
    ('exceptional-hammer-eye', 'Exceptional Hammer (Eye Acc)', 'exceptional-hammer-eye.png', NULL, NULL, 1, 3),
    ('exceptional-hammer-earrings', 'Exceptional Hammer (Earrings)', 'exceptional-hammer-earrings.png', NULL, NULL, 1, 4),
    ('exceptional-hammer-medal', 'Exceptional Hammer (Medal)', 'exceptional-hammer-medal.png', NULL, NULL, 1, 5),
    ('grindstone-of-faith', 'Grindstone of Faith', 'grindstone-of-faith.png', NULL, NULL, 1, 6),
    ('grindstone-of-life', 'Grindstone of Life', 'grindstone-of-life.png', NULL, NULL, 1, 7),
    ('premium-scroll-accessory-coupon', 'Premium Scroll - Accessory Coupon', 'premium-scroll-accessory-coupon.png', NULL, 'INTERACTIVE', 1, 8),
    ('premium-scroll-pet-equipment-coupon', 'Premium Scroll - Pet Equipment Coupon', 'premium-scroll-pet-equipment-coupon.png', NULL, 'INTERACTIVE', 1, 9),
    ('magical-scroll-weapon-coupon', 'Magical Scroll - Weapon Coupon', 'magical-scroll-weapon-coupon.png', NULL, 'INTERACTIVE', 1, 10),
    ('eternal-armor-of-desire-box', 'Eternal Armor of Desire Box', 'eternal-armor-of-desire-box.png', NULL, NULL, 1, 11),
    ('divine-eternal-armor-box', 'Divine Eternal Armor Box', 'divine-eternal-armor-box.png', NULL, NULL, 1, 12),
    ('ferocious-beast-eternal-armor-box', 'Ferocious Beast Eternal Armor Box', 'ferocious-beast-eternal-armor-box.png', NULL, NULL, 1, 13),
    ('ancient-eternal-armor-box', 'Ancient Eternal Armor Box', 'ancient-eternal-armor-box.png', NULL, NULL, 1, 14),
    ('eternal-armor-of-oaths-box', 'Eternal Armor of Oaths Box', 'eternal-armor-of-oaths-box.png', NULL, NULL, 1, 15),
    ('eternal-armor-of-radiance-box', 'Eternal Armor of Radiance Box', NULL, NULL, NULL, 1, 16),
    ('mitras-rage-selection-box', 'Mitra''s Rage Selection Box', 'mitras-rage-selection-box.png', NULL, NULL, 1, 17),
    ('ring-of-restraint-4', 'Ring of Restraint Lv. 4', 'ring-of-restraint-4.png', 'HEROIC', NULL, 1, 18),
    ('continuous-ring-4', 'Continuous Ring Lv. 4', 'continuous-ring-4.png', 'HEROIC', NULL, 1, 19),
    ('distorted-ambition', 'Distorted Ambition', 'distorted-ambition.png', 'ALWAYS', NULL, 2, 20)
...
FROM (VALUES
    ('limbo', 'grindstone-of-faith', 0),
    ('limbo', 'premium-scroll-accessory-coupon', 1),
    ('limbo', 'premium-scroll-pet-equipment-coupon', 2),
    ('limbo', 'magical-scroll-weapon-coupon', 3),
    ('limbo', 'distorted-ambition', 4),
    ('limbo', 'eternal-armor-of-desire-box', 5),
    ('limbo', 'ring-of-restraint-4', 6),
    ('limbo', 'continuous-ring-4', 7),
    ...
    ('malefic-star', 'grindstone-of-faith', 0),
    ('malefic-star', 'premium-scroll-accessory-coupon', 1),
    ('malefic-star', 'premium-scroll-pet-equipment-coupon', 2),
    ('malefic-star', 'magical-scroll-weapon-coupon', 3),
    ('malefic-star', 'eternal-armor-of-radiance-box', 4),
    ('malefic-star', 'ring-of-restraint-4', 5),
    ('malefic-star', 'continuous-ring-4', 6),
