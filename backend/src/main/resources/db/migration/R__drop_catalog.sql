...
FROM (VALUES
    ...
    ('limbo', 'eternal-armor-of-desire-box', 2),
    ('limbo', 'ring-of-restraint-4', 3),
    ('limbo', 'continuous-ring-4', 4),
    ('limbo', 'vestige-of-erion', 5),
    ...
    ('kaling', 'ferocious-beast-eternal-armor-box', 2),
    ('kaling', 'ring-of-restraint-4', 3),
    ('kaling', 'continuous-ring-4', 4),
    ('kaling', 'vestige-of-erion', 5),
    ...
    ('malefic-star', 'eternal-armor-of-radiance-box', 2),
    ('malefic-star', 'ring-of-restraint-4', 3),
    ('malefic-star', 'continuous-ring-4', 4),
    ('malefic-star', 'vestige-of-erion', 5),
    ('jupiter', 'vestige-of-erion', 0),
    ('baldrix', 'oath-of-death', 0),
    ('baldrix', 'grindstone-of-faith', 1),
    ('baldrix', 'eternal-armor-of-oaths-box', 2),
    ('baldrix', 'ring-of-restraint-4', 3),
    ('baldrix', 'continuous-ring-4', 4),
    ('baldrix', 'vestige-of-erion', 5)
