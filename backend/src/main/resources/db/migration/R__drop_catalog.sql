...
FROM (VALUES
    ...
    ('vestige-of-erion', 'Vestige of Erion Coupon', 'vestige-of-erion.png', NULL, NULL, 1, FALSE, FALSE, 23),
    ('distorted-ambition', 'Distorted Ambition', 'distorted-ambition.png', 'ALWAYS', NULL, 1, FALSE, TRUE, 24),
    ('kalos-token', 'Kalos''s Residual Determination', 'kalos-token.png', 'HEROIC', NULL, 1, FALSE, TRUE, 25),
    ('kalos-residual-determination-fragment', 'Kalos''s Residual Determination Fragment', 'kalos-residual-determination-fragment.png', 'HEROIC', NULL, 1, FALSE, TRUE, 26),
    ('ferocious-beast-ring', 'Ferocious Beast Entanglement Ring', 'ferocious-beast-ring.png', 'HEROIC', NULL, 1, FALSE, TRUE, 27),
    ('ferocious-entanglement-ring-fragment', 'Ferocious Entanglement Ring Fragment', 'ferocious-entanglement-ring-fragment.png', 'HEROIC', NULL, 1, FALSE, TRUE, 28),
    ('echo-ancient-resolve', 'Echo of Ancient Resolve', 'echo-ancient-resolve.png', 'HEROIC', NULL, 1, FALSE, TRUE, 29),
