...
FROM (VALUES
    ...
    ('exceptional-hammer-medal', 'Exceptional Hammer (Medal)', 'exceptional-hammer-medal.png', NULL, NULL, 1, FALSE, FALSE, 8),
    ('grindstone-of-faith', 'Grindstone of Faith', 'grindstone-of-faith.png', NULL, NULL, 1, TRUE, FALSE, 9),
    ('grindstone-of-life', 'Grindstone of Life', 'grindstone-of-life.png', NULL, NULL, 1, TRUE, FALSE, 10),
    ('eternal-armor-of-desire-box', 'Eternal Armor of Desire Box', 'eternal-armor-of-desire-box.png', NULL, NULL, 1, TRUE, FALSE, 11),
    ('divine-eternal-armor-box', 'Divine Eternal Armor Box', 'divine-eternal-armor-box.png', NULL, NULL, 1, TRUE, FALSE, 12),
    ('ferocious-beast-eternal-armor-box', 'Ferocious Beast Eternal Armor Box', 'ferocious-beast-eternal-armor-box.png', NULL, NULL, 1, TRUE, FALSE, 13),
    ('ancient-eternal-armor-box', 'Ancient Eternal Armor Box', 'ancient-eternal-armor-box.png', NULL, NULL, 1, TRUE, FALSE, 14),
    ('eternal-armor-of-oaths-box', 'Eternal Armor of Oaths Box', 'eternal-armor-of-oaths-box.png', NULL, NULL, 1, TRUE, FALSE, 15),
    ('eternal-armor-of-radiance-box', 'Eternal Armor of Radiance Box', 'eternal-armor-of-radiance-box.png', NULL, NULL, 1, TRUE, FALSE, 16),
    ('eternal-twisted-armor-box', 'Eternal Twisted Armor Box', 'eternal-twisted-armor-box.png', NULL, NULL, 1, TRUE, FALSE, 17),
    ('mitras-rage-selection-box', 'Mitra''s Rage Selection Box', 'mitras-rage-selection-box.png', NULL, NULL, 1, FALSE, FALSE, 18),
    ('ring-of-restraint-4', 'Ring of Restraint Lv. 4', 'ring-of-restraint-4.png', 'HEROIC', NULL, 1, FALSE, FALSE, 19),
    ('continuous-ring-4', 'Continuous Ring Lv. 4', 'continuous-ring-4.png', 'HEROIC', NULL, 1, FALSE, FALSE, 20),
    ('vestige-of-erion', 'Vestige of Erion Coupon', 'vestige-of-erion.png', NULL, NULL, 1, FALSE, FALSE, 21),
    ('distorted-ambition', 'Distorted Ambition', 'distorted-ambition.png', 'ALWAYS', NULL, 1, FALSE, TRUE, 22),
    ('kalos-token', 'Kalos''s Residual Determination', 'kalos-token.png', 'HEROIC', NULL, 1, FALSE, TRUE, 23),
    ('kalos-residual-determination-fragment', 'Kalos''s Residual Determination Fragment', 'kalos-residual-determination-fragment.png', 'HEROIC', NULL, 1, FALSE, TRUE, 24),
    ('ferocious-beast-ring', 'Ferocious Beast Entanglement Ring', 'ferocious-beast-ring.png', 'HEROIC', NULL, 1, FALSE, TRUE, 25),
    ('ferocious-entanglement-ring-fragment', 'Ferocious Entanglement Ring Fragment', 'ferocious-entanglement-ring-fragment.png', 'HEROIC', NULL, 1, FALSE, TRUE, 26),
    ('echo-ancient-resolve', 'Echo of Ancient Resolve', 'echo-ancient-resolve.png', 'HEROIC', NULL, 1, FALSE, TRUE, 27),
    ('whisper-ancient-resolve', 'Whisper of Ancient Resolve', 'whisper-ancient-resolve.png', 'HEROIC', NULL, 1, FALSE, TRUE, 28),
    ('blissful-fantasy-shard', 'Blissful Fantasy Shard', 'blissful-fantasy-shard.png', 'HEROIC', NULL, 1, FALSE, TRUE, 29),
    ('blissful-fantasy-fragment', 'Blissful Fantasy Fragment', NULL, 'HEROIC', NULL, 1, FALSE, TRUE, 30),
    ('lingering-twisted-desire', 'Lingering Twisted Desire', NULL, 'ALWAYS', NULL, 1, FALSE, TRUE, 31),
    ('trace-eternal-loyalty', 'Trace of Eternal Loyalty', 'trace-eternal-loyalty.png', 'ALWAYS', NULL, 1, FALSE, TRUE, 32)
...
FROM (VALUES
    ...
    ('jupiter', 'eternal-twisted-armor-box', 2),
    ('jupiter', 'ring-of-restraint-4', 3),
    ('jupiter', 'continuous-ring-4', 4),
    ('jupiter', 'vestige-of-erion', 5),
    ('jupiter', 'lingering-twisted-desire', 6),
